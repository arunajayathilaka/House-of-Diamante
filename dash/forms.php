...
<body>  
	...
	<?php 
            ...
            $resq = mysql_query($query1);
            $rowq = mysql_fetch_array($resq,MYSQLI_ASSOC);
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="detailchanger" style="background-color:#e9ecf2;;">
                            ...
                            <form method="post"  enctype="multipart/form-data" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
                                <div class="row">
                                    <div class="form-group" >
                                        <div class="col-lg-8"><div style="float: right;">
                                                <input id="imginp<?=$rowq['id'];?>" style="display:none" onchange="readURL(this,'disimg<?=$rowq['id'];?>');" type="file" name="image"  value="<?php echo $rowq['image_url'] ;?> " />
                                                <img class="img-responsive"id="disimg<?=$rowq['id'];?>" onclick="openBrowse('imginp<?=$rowq['id'];?>')" src="<?php echo $rowq['image_url']  ;?> " style="height:200px; width:400px;"/>
                                        </div></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-lg-3" ><div style="float: right;">New Name</div></div>
                            ...
                            <div class="row">
                                <div class="form-group ">
                                    <div class="col-lg-3"><div style="float: right;">Current Password</div></div>
                           ...
                           <span class="error" style="color: red;"><?php echo $adderror ;?></span>
                           ...
                           <br/>
                            ...
                            <span class="error" style="color: red;"><?php echo $emerror ;?></span>
                            </br>
                            <br/>
        ...
        <script type="text/javascript">
            ...
            $("#namepencil").click(function(){
                    $("#cName").prop('disabled',false);
                    
            });
            
            $("#passpencil").click(function(){
                    $("#newpassword").prop('disabled',false);
            });
            
            $("#addpencil").click(function(){
                    $("#address").prop('disabled',false);     
            });
            
            $("#cpasspencil").click(function(){
                    $("#confirmpassword").prop('disabled',false);      
            });
            
            $("#emailpencil").click(function(){
                    $("#email").prop('disabled',false);      
            });
            
            $("#telpencil").click(function(){
