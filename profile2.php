    ...
    <script>
    	...
    	$(document).ready(function(){
    		$("#saved").click(function(){
    			...
    			$.post($("#myForm").attr("action"), data, function(info){$('#response').html(info)});
    		});
					...
					<div id="menu2" class="tab-pane fade">
						...
						<div class="text-center" style="width:90%; height:75px;background:grey;color:white;padding:20px;margin-bottom:10px;">
							<div class="pull-left">
								...
								<label style="margin-left:-22%; position:absolute; margin-top:20px;" name="<?php echo $id;?>"></label>
							</div>
											...
											<div class="row">
												<div class="col-md-3">
													<a href="#" class="thumbnail">
														<img src="img/designed-items/bangle.png" style="height:100px;"/>
													</a>
												</div>
							...
							while ($rows2 = mysqli_fetch_assoc($query2_run)) {
								...
								<div class="text-center" style="width:90%; height:75px;background:blue;color:white;padding:20px;margin-bottom:10px;"> 
									<div class="pull-left">
										...
										<label style="margin-left:-22%; position:absolute; margin-top:20px;">viewed</label>
									</div>
						...
						<div class="row">
						  <div class="col-md-3">
						    <a href="img/designed-items/bangle.png" class="thumbnail">
						      ...
						      <img src="img/designed-items/bangle.png" alt="Pulpit Rock">
						    </a>
						  </div>
						  <div class="col-md-3">
						    <a href="chain.png" class="thumbnail">
						      <p>Type:Chain<br>Metal:Gold<br>Size:5</p>
						      <img src="img/designed-items/chain.png" alt="Moustiers Sainte Marie">
						    </a>
						  </div>
						  <div class="col-md-3">
						    <a href="bracelet.png" class="thumbnail">
						      <p>Type:Bracelet<br>Metal:Gold<br>Size:5</p>
						      <img src="img/designed-items/bracelet.png" alt="Cinque Terre">
						    </a>
						  </div>
						</div>
					</div>
					...
					<div id="menu4" class="tab-pane fade">
							...
							<form id="myForm" action="prof_mod.php"  method="post">
								...
								<div class="form-group has-feedback">
								    ...
								    <input type="password" class="form-control" placeholder="Enter current password" name="cpwd" id="cpwd" value="" />
								    <i class="glyphicon glyphicon-pencil form-control-feedback"></i>
								</div>

								<div class="form-group has-feedback">
								    <label class="control-label">New Password:</label>
								    <input type="password" class="form-control" placeholder="Enter new password" name="npwd" id="npwd" />
								    <i class="glyphicon glyphicon-pencil form-control-feedback"></i>
								</div>
